...
namespace GridShared.Columns
{
    ...
    public interface IGridColumn : ISortableColumn, IFilterableColumn
    {
        ...
        string TabGroup { get; }
        /// <summary>
        /// Set's whether the checkbox column should have a checkbox in header to be able to select/unselect all at a time
        /// </summary>
        bool HeaderCheckbox { get; }
        /// <summary>
        /// Sets grid mode to only allow one row checkbox to be selected at a time
        /// </summary>
        bool SingleCheckbox { get; }
        /// <summary>
        /// Sets GridColumn header tooltip value
        /// </summary>
